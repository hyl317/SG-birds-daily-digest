# Common Acronyms — SG Birds Group

## Locations
<!-- e.g. SBWR = Sungei Buloh Wetland Reserve -->

## Bird Species
<!-- e.g. WBE = White-bellied Sea Eagle -->

## Other
<!-- e.g. ID = identification -->

<!-- Auto-detected 31 Mar 2026 -->
- PF = Peregrine Falcon
...
- OD = Oriental Darter
- RH = Rhinoceros Hornbill

<!-- Auto-detected 01 Apr 2026 -->
- OHT = Orange-headed Thrush
- PRP = Pasir Ris Park
